...
Compile: ./objects/main.o  ./objects/sort.o  ./objects/utilits.o  ./objects/input_output.o
		g++  ./objects/main.o  ./objects/sort.o ./objects/utilits.o  ./objects/input_output.o $(FLAGS) -o app 
./objects/main.o : src/main.cpp 
		g++ -c src/main.cpp -o ./objects/main.o	
./objects/sort.o: src/sort.cpp heders/sort.h 
		g++ -c src/sort.cpp -o ./objects/sort.o
./objects/utilits.o: src/utilits.cpp heders/utilits.h 
		g++ -c src/utilits.cpp -o ./objects/utilits.o
./objects/input_output.o: src/input_output.cpp heders/input_output.h 
		g++ -c src/input_output.cpp -o ./objects/input_output.o

clean:    
	rm ./objects/*.o app   sort_text.txt